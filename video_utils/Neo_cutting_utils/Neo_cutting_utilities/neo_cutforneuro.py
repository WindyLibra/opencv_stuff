...
def extract_frames_and_resize(video_path, save_dir, resize_width=1280, resize_height=960, frame_skip=4):
    """
...
with open('config_video.txt', 'r') as cfg:
    direc = cfg.readline()
    video_path, save_dir = get_video_path_and_save_dir(f'{direc}')
